...
Hands-on Python practice exercises that build programming fundamentals step by step — from basic `print()` statements to operators, conditionals, loops, functions, decorators, and data structures. Each lab is a self-contained script demonstrating one concept, plus daily challenge tasks and browser-automation tests.
...
Each exercise is a self-contained lab script that demonstrates a specific concept. See [chapter_11_Python_Learning/README.md](chapter_11_Python_Learning/README.md) for the full lab-by-lab breakdown.
...
See [autoweave/README.md](chapter_11_Python_Learning/autoweave/README.md) for full setup (venv, Playwright Chromium install, run commands) and troubleshooting.
...
From the repo root, run any lab with:

```bash
python chapter_11_Python_Learning/ex_01_Python_Basics/Lab001_Hello.py
python chapter_11_Python_Learning/ex_02_Keywords_Identifier_Variables/Lab010_maths.py
python chapter_11_Python_Learning/ex_03_Literals/Lab023_Strings.py
python chapter_11_Python_Learning/ex_04_Operators/Lab031_Arth_Op.py
python chapter_11_Python_Learning/Task/task1.py
```

Some exercises (e.g. `Lab021`, `Lab022`, `Lab023`, `task1.py`) prompt for input — type your values and press Enter when prompted.

The `autoweave` tests are run differently — see [autoweave/README.md](chapter_11_Python_Learning/autoweave/README.md) for the `uv`-based setup and `pytest` commands.
...
7. Organize data with lists (**ex_13**) and tuples (**ex_14**).
8. Solidify each topic with the daily **Task** challenges.
9. Apply it all to real browser automation with **autoweave** (Playwright).
