...
A hands-on collection of Python practice exercises covering the fundamentals — from basic `print` statements to operators, conditionals, loops, functions, decorators, and data structures. Each exercise is a self-contained lab script that demonstrates a specific concept, plus daily challenge tasks and browser-automation tests.
...
python ex_04_Operators/Lab031_Arth_Op.py
