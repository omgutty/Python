...
A hands-on collection of Python practice exercises covering the fundamentals, from basic `print` statements to data types, user input, and string operations. Each exercise is a self-contained lab script that demonstrates a specific concept.
...
From the `chapter_11_Python_Learning` directory, run any lab with:

```bash
python ex_01_Python_Basics/Lab001_Hello.py
python ex_02_Keywords_Identifier_Variables/Lab010_maths.py
python ex_03_Literals/Lab023_Strings.py
```

Some exercises (e.g. `Lab021`, `Lab022`, `Lab023`) prompt for input — type your values and press Enter when prompted.

## Learning Path

1. Start with **ex_01** to get comfortable with `print()` and comments.
2. Move to **ex_02** to learn about keywords, identifiers, variables, and arithmetic.
3. Finish with **ex_03** for literals, data types, built-in functions, and user input.
